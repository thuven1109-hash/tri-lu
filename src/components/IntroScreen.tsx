...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onStart, onToggleSidebar, userProfiles }) => {
  ...
  const AVATAR_OPTIONS = [
    "https://lh3.googleusercontent.com/u/0/d/1W3r3_P-4vX8m9QgarPCKgwjG1F40aVH1"
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onStart({
      name: name.trim(),
      appearance: appearance.trim() || "đẹp khuynh quốc khuynh thành, vẻ đẹp đài các nhưng phảng phất nét u buồn, sầu mộng. Thường mặc áo bà ba lụa màu mỡ gà hoặc trắng ngà.",
      personality: personality.trim(),
      age: 20,
      background: "Xuất thân là con gái cưng của một Thầy Đồ nghèo miệt bến lở. Hiện là Mợ Ba chính thất của phủ Hội Đồng Huỳnh."
    }, selectedAvatar);
  };
